...
class Feedback4Controller extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        $feedback_question = DB::table('feedback_question')->where('feedback_id','4')->select('*', DB::raw('@rownum := @rownum + 1 AS rownum'));

        $base_path = $this->data['base_path'];
        if (!$request->ajax()) {
            return view('admin.feedback_survey_4.index_4', $this->data);
        }
        return Datatables::of($feedback_question)
            ->addColumn('action', function ($row) {
                $edit_url = route('feedback_survey_4.edit', $row->id);
                $delete_url = route('feedback_survey_4.destroy', $row->id);
    ...
    {
        return view('admin.feedback_survey_4.create_4', $this->data);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->to('admin/feedback_survey_4')->with('success', __('message.question') . ' ' . __('message.created') . ' ' . __('message.successfully'));
    }
    ...
    {
        $feedback = DB::table('feedback_question')->where('id', $id)->where('feedback_id', '4')->first();

        return view('admin.feedback_survey_4.edit_4', $this->data, compact('feedback'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->to('admin/feedback_survey_4');
    }
    ...
    {
        //dd($request);
        $question = DB::table('selected_feedback_question')->where('feedback_id','4')->first();
        $feedback_reason = FeedbackReason::where('feedback_id','4')->get();

        $this->data['feedback_reason'] = $feedback_reason;
        $this->data['question'] = $question;
        if (!$request->ajax()) {
            return view('admin.feedback_survey_4.choose_question_4', $this->data);
        }

        DB::statement(DB::raw('set @rownum=0'));
        $feedback_question = DB::table('feedback_question')->where('feedback_id','4')->select('*', DB::raw('@rownum := @rownum + 1 AS rownum'));
        $select = DB::table('selected_feedback_question')->where('feedback_id','4')->get();
        $base_path = $this->data['base_path'];
        return Datatables::of($feedback_question)
            ->addColumn('action', function ($row) {
                $links = "";
            ...
            ->addColumn('checkbox', function ($row) {
                $select = DB::table('selected_feedback_question')->where('feedback_id','4')->first();
    ...
    public function store_question(Request $request)
    {
        ...
        $selected_feedback_question = DB::table('selected_feedback_question')->where('feedback_id',4)->first();
        ...
        if ($selected_feedback_question != null) {
            DB::table('selected_feedback_question')->where('feedback_id', 4)->update([
        ...
        return redirect()->to('admin/show_feedback_survey_4');
    }
    //show question form in fron end
    public function get_question_form()
    {
        $question = DB::table('feedback_question')->where('feedback_id', 4)->where('is_selected', 1)->orderBy('question_order', 'asc')->get();
        $selected_feedback_question = DB::table('selected_feedback_question')->where('feedback_id', 4)->first();
        ...
        return view('feedback_survey_4', compact('selected_feedback_question', 'question', 'feedback_reason'), $this->data);
    }
    ...
    public function show_question_answer(Request $request)
    {
        ...
        DB::statement(DB::raw('set @rownum=0'));
        $question_answer = DB::table('feedback_survey')->select('*', DB::raw('@rownum := @rownum + 1 AS rownum'))->where('feedback_id','4');
        if (!$request->ajax()) {
            return view('admin.feedback_survey_4.show_question_answer_4', $this->data);
        }
        $base_path = $this->data['base_path'];
    ...
    public function question_chart($user_id = null, $city = null, $created_from = null, $created_to = null, $time_period = null)
    {
        ...
        $question = DB::table('feedback_question')
            ...
            ->where('feedback_question.feedback_id','4')
            ->get();
            //dd($question);
        $feedback_question[] = $question;
        $user = User::pluck('name', 'id');
        $location = City::pluck('cityName', 'cityName');
        $total_question = DB::table('feedback_question')->select('*')->where('feedback_question.feedback_id','4')->get();
        ...
        return view('admin.feedback_survey_4.question_chart_4', $this->data);
    }
    ...
    public function getFeedbackRatings(Request $request)
    {
        ...
        $feedback_question = DB::table('feedback_rating')
            ...
            ->where('feedback_rating.feedback_id','4')
            ->select('feedback_rating.*', DB::raw('@rownum := @rownum + 1 AS rownum'), 'users.*');
        //dd($feedback_question->get());    
        $base_path = $this->data['base_path'];
        if (!$request->ajax()) {
            return view('admin.feedback_survey_4.feedback_rating_4', $this->data);
        }
        return Datatables::of($feedback_question)
            ->addColumn('action', function ($row) {
    ...
    public function reason_chart($user_id = null, $city = null, $created_from = null, $created_to = null, $time_period = null)
    {
        ...
        $reason = DB::table('feedback_reason')->where('feedback_id','4')->select('*');
        ...
        $total = 0;
        $results_total = DB::table('feedback_reason')->where('feedback_id','4')->select('*')->get();
        ...
        // dd($monthData);
        $feedBackReason = DB::table('feedback_reason')->where('feedback_id','4')->select('*')->get();
        ...
        return view('admin.feedback_survey_4.reason_chart_4', $this->data);
    }
    ...
    public function show_table_value(Request $request)
    {
        try {
            ...
            if (!$request->ajax()) {
                return view('admin.feedback_survey_4.show_table_value_4', $this->data);
            }
    ...
    public function getResponseData($extraData)
    {
        //dd($extraData);
        DB::statement(DB::raw('set @rownum=0'));
            $query = DB::table('feedback_survey')->where('feedback_survey.feedback_id', '4');
                //dd($query->get());
