...
class Reason2Controller extends Controller
{
    /**
    ...
    public function get_reason_setting()
    {
        ...
        return view('admin.feedback_survey_2.reason_setting_2', $this->data);
    }
    public function reason_setting(Request $request)
    {
        ...
        try {
            ...
            if ($request->get('reason')) {
                ...
                $isExist = FeedbackReason::where('feedback_id','2')->delete();
