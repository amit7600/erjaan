...
class Reason4Controller extends Controller
{
    /**
    ...
    public function get_reason_setting()
    {
        ...
        return view('admin.feedback_survey_4.reason_setting_4', $this->data);
    }
    public function reason_setting(Request $request)
    {
        ...
        try {
            ...
            if ($request->get('reason')) {
                ...
                $isExist = FeedbackReason::where('feedback_id','4')->delete();
