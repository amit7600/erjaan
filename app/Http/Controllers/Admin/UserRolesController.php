    ...
    public function store(Request $request)
    {
        ...
        try {
            $role = UserRoles::create([
                ...
                'feedback_response' => $request->get('feedback_response'),
                ...
                'feedback_response_2' => $request->get('feedback_response_2'),
                ...
                'feedback_response_3' => $request->get('feedback_response_3'),
                ...
                'feedback_response_4' => $request->get('feedback_response_4'),
                ...
                'feedback_response_5' => $request->get('feedback_response_5'),
