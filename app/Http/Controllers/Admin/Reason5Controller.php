...
class Reason5Controller extends Controller
{
    /**
    ...
    public function get_reason_setting()
    {
        ...
        return view('admin.feedback_survey_5.reason_setting_5', $this->data);
    }
    public function reason_setting(Request $request)
    {
        ...
        try {
            ...
            if ($request->get('reason')) {
                ...
                $isExist = FeedbackReason::where('feedback_id','5')->delete();
