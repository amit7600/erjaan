...
class Reason3Controller extends Controller
{
    /**
    ...
    public function get_reason_setting()
    {
        ...
        return view('admin.feedback_survey_3.reason_setting_3', $this->data);
    }
    public function reason_setting(Request $request)
    {
        ...
        try {
            ...
            if ($request->get('reason')) {
                ...
                $isExist = FeedbackReason::where('feedback_id','3')->delete();
