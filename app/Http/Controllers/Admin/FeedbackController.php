...
class FeedbackController extends Controller
{
    ...
    {
        $feedback = DB::table('feedback_question')->where('id', $id)->where('feedback_id', '1')->first();
    ...
    {
        $question = DB::table('feedback_question')->where('feedback_id', 1)->where('is_selected', 1)->orderBy('question_order', 'asc')->get();
