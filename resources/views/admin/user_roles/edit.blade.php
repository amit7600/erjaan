...
<div class="row">
    <div class="col-lg-12 mb-3">
        {!! Form::model($role, ['route' => ['user_roles.update', $role->id], 'files' => true, 'method' => 'PUT', 'class'
        => 'form-horizontal']) !!}
        @if ($errors->any())
                    ...
                    <div class="col-sm-6 col-md-6 col-xs-12 mb-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <label for="staticEmail"
                                        class="ul-form__label col-lg-9  col-md-9 col-sm-9 col-form-label text-left pl-4">-{{__('message.auto_send')}}</label>
                                    <div class="col-lg-2  col-md-2 col-sm-2 mb-2">
                                        <label class="checkbox checkbox-primary">
                                ...
                                <div class="form-group row">
                                    <label for="staticEmail"
                                        class="ul-form__label col-lg-9  col-md-9 col-sm-9 col-form-label text-left pl-4">--{{__('message.add_new_trigger')}}</label>
                                    <div class="col-lg-2  col-md-2 col-sm-2 mb-2">
                                        <label class="checkbox checkbox-primary">
                                ...
                                <div class="form-group row">
                                    <label for="staticEmail"
                                        class="ul-form__label col-lg-9  col-md-9 col-sm-9 col-form-label text-left pl-4">--{{__('message.kpi_report')}}</label>
                                    <div class="col-lg-2  col-md-2 col-sm-2 mb-2">
                                        <label class="checkbox checkbox-primary">
                                ...
                                <div class="form-group row">
                                    <label for="staticEmail"
                                        class="ul-form__label col-lg-9  col-md-9 col-sm-9 col-form-label text-left pl-4">{{__('message.complain_menu')}}</label>
                                    <div class="col-lg-2  col-md-2 col-sm-2 mb-2">
                                        <label class="checkbox checkbox-primary">
