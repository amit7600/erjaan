...
<div class="row">
    <div class="col-lg-12 mb-3">
        ...
        @endif
        <!--begin::form 2-->
        {!! Form::open(['route' => 'get_location_report_filter_4']) !!}
                ...
                foreach ($tempArray as $key => $city) { 
                    ...
                    foreach ($city as $key => $value) {
                        $city_id = $value->id;
                            ...
                            $total_result_count = FeedbackHelper::getTotalcity($city_id,'4');
                        ...
                        if($time_period == 'last_14_day'){
                            ...
                            for ($y = $start_number; $y <= $year_month_value; $y++) {
                                ...
                                $city_count = FeedbackHelper::getLocationCount($year_data,'4', $city_id,$created_from,$created_to,$time_period);
