                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center">{{__('message.trigger_name')}}</th>
                                <th style="width:3%" class="text-center">{{__('message.trigger_time')}}</th>
                                <!-- <th class="text-center">Survey Name</th> -->
                                <th class="text-center">{{__('message.trigger_type')}}</th>
                                <th class="text-center">{{__('message.sending_campaign')}}</th>
                                <th class="text-center">{{__('message.sending_method')}}</th>
...
var ajaxUrl = '{!! route('trigger.index') !!}'; //Url of ajax datatable where you fetch data
