...
<div class="row">
    <div class="col-lg-12 mb-3">
        ...
        @endif
        <!--begin::form 2-->
        {!! Form::open(['route' => 'reason_chart_filter']) !!}
        <!-- start SURVEY Form Layout-->
        <div class="card mb-4">
            <div class="card-header bg-transparent">
                <h3 class="card-title">{{__('message.reason')}} {{__('message.report')}} {{__('message.chart')}}</h3>
            </div>
            <div class="card-body ">
                <div class="row">
                ...
                <div class="mc-footer">
                    <div class="row text-right">
                        <div class="col-lg-12 text-center">
                            <button type="submit" class="btn btn-success" id="btn-search">{{__('message.view')}} {{__('message.report')}}</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card card-icon-bg card-icon-bg-primary o-hidden mb-4">
                    ...
                    <h3 class="text-center m-0 mb-3 p-2">{{__('message.feedback')}} {{__('message.reason')}}</h3>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    <div class="x_content">
                                        ...
                                        <button class="btn btn-primary mb-3" style="width: 20%;margin: 0 auto;" onclick="printChart('reasonchart_material_<?php echo $reason_id; ?>','{{__('message.reason')}} {{__('message.report')}} {{__('message.chart')}}','{{array_sum($allResponses)}}')" >Print !</button>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div id="reasonchart_material_<?php echo $reason_id; ?>" class="p-3"
                                    ...
                                    <div class="row">
                                        ...
                                        @endphp
                                        <div class="col-md-4">
                                            <p class="text-16 mb-3 text-center"><b> {{$feedback_reason}} : </b> {{$response_array[$key][$feedback_reason]}}</p>
                                            @php
                                                $allResponses[] = $response_array[$key][$feedback_reason];
                                            @endphp
                                        </div>
