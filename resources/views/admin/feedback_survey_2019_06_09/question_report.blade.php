...
<div class="breadcrumb">
    <h1>{{__('message.question')}} {{__('message.guage')}} {{__('message.report')}}</h1>
</div>
                ...
                success: function (resp) {
                    ...
                    if (resp) {
                        ...
                        for (var i = 0; i < resp['final_value'].length; i++) {
                            ...
                            $('#choose_question').append(' <table class="table" style="width: 50%; float: left;"> <tr> <td style="border-top:none;"> <div class="text-center card card-icon-bg card-icon-bg-primary o-hidden pb-2"> <div style="height: 400px;"> <h3 class="p-2 text-16">{{__('message.question')}}: '+ resp['survey_form'][i].question +' </h3> <div class="col-md-12 col-sm-12 col-xs-12" id="report_div_' + i + '" style="height: 400px;"></div></div><div class="row"> <div class="col-md-12 col-12 text-center"> <p class="text-14 mt-1 mb-1"><b>{{__('message.no')}} {{__('message.of')}} {{__('message.responses')}}:</b> '+ resp['final_value'][i].response +'</p></div></div><div class="row"> <div class="col-md-12" style="text-align: center !important;"> <button class="btn btn-primary mb-3" style="width: 20%;margin: 0 auto;" data-name="'+ resp['survey_form'][i].question +'" data-id="report_div_'+ i +'" data-value="'+ resp['final_value'][i].response +'" onclick="printChart(this)">Print !</button> </div></div></div></td></tr></table>');
                        ...
                        var kpiSum = '{{__('message.kpi')}} {{__('message.total_c')}} : ' + sum;
