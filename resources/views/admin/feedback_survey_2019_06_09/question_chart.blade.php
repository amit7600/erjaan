        ...
        <div class="row" id="printableArea" >
            ...
            <div class="col-md-6 col-sm-6 col-xs-12" >
                <div class="x_panel">
                    <div class="x_content text-center card card-icon-bg card-icon-bg-primary o-hidden mb-5 pb-2">
                        ...
                        <button class="btn btn-primary mb-3" style="width: 20%;margin: 0 auto;" onclick="printChart('columnchart_material_<?php echo $question_id; ?>','<?php echo $question1->question ?>','{{array_sum($response_array)}}')" >Print !</button>                        
                    </div>
                </div>
                <script type="text/javascript">
                    ...
                    html2canvas($("#columnchart_material_<?php echo $question_id; ?>"), {
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="text-center card card-icon-bg card-icon-bg-primary o-hidden mb-5 pb-2 ">
                    <h3 class="p-2" id="title_columnchart_material_<?php echo $question_id; ?>">{{$question1->question}}</h3>
...
<script type="text/javascript">
        function printChart123(id,title){
            ...
            // var titleName = document.getElementById("title_"+id);
            // var context = titleName.getContext("2d");
            // var titleImg = titleName.toDataURL("image/png");
            
            html2canvas($("#title_columnchart_material_5"), {
                onrendered: function(titleName) {         
                  var  titleImg = titleName.toDataURL(
                        'image/png');
                  console.log(titleImg)
                var doc = new jsPDF('L', 'mm');
                    doc.addImage(titleImg, 'PNG',  5, 5, 280, 0);
                    // doc.addImage(imgData, 'PNG',  10, 10, 280, 0);
                    doc.setFontSize(20)
                    // doc.text(120, 15, titleImg)
...
<script>
    $(document).ready(function(){
            ...
            if(time_period == 'specific_date'){
                $('.append_filter').append('<div class="row"> <div class="col-md-6 col-6 text-center"> <p class="text-14 mt-1 mb-1"><b>{{__('message.User')}}:</b> '+user+'</p></div><div class="col-md-6 col-6 text-center"> <p class="text-14 mt-1 mb-1"><b>{{__('message.time_period')}}:</b> '+time_period+'</p></div><div class="col-md-6 col-6 text-center"> <p class="text-14 mt-1 mb-1"><b>{{__('message.location')}}:</b> '+city+'</p></div><div class="col-md-6 col-6 text-center"> <p class="text-14 mt-1 mb-1"><b>{{__('message.chart')}} {{__('message.type')}}:</b> '+select_chart_type+'</p></div><div class="col-md-6 col-6 text-center"> <p class="text-14 mt-1 mb-1"><b>{{__('message.created')}} {{__('message.from')}}:</b> '+created_from+'</p></div><div class="col-md-6 col-6 text-center"> <p class="text-14 mt-1 mb-1"><b>{{__('message.created')}} {{__('message.to')}}:</b> '+created_to+'</p></div></div>');
            }else{
                $('.append_filter').append('<div class="row"> <div class="col-md-6 col-6 text-center"> <p class="text-14 mt-1 mb-1"><b>{{__('message.User')}}:</b> '+user+'</p></div><div class="col-md-6 col-6 text-center"> <p class="text-14 mt-1 mb-1"><b>{{__('message.time_period')}} :</b> '+time_period+'</p></div><div class="col-md-6 col-6 text-center"> <p class="text-14 mt-1 mb-1"><b>{{__('message.location')}}:</b> '+city+'</p></div><div class="col-md-6 col-6 text-center"> <p class="text-14 mt-1 mb-1"><b>{{__('message.chart')}} {{__('message.type')}}:</b> '+select_chart_type+'</p></div></div>');
            }
    })
