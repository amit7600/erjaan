        ...
        <div class="card mb-4 text-left">
            <div class="card-body">
                <h4 class="card-title mb-3">
                    {{__('message.question')}} {{__('message.list')}}
                    <a href="{{route('feedback_survey.create')}}"
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center">{{__('message.question')}} {{__('message.order')}}</th>
...
var ajaxUrl = '{!! route('feedback_survey.index') !!}'; //Url of ajax datatable where you fetch data
