    ...
    <div class="col-lg-12 mb-3">
        ...
        <div class="card mb-4">
            <div class="card-header bg-transparent">
                <h3 class="card-title">{{__('message.reason')}} {{__('message.setting')}}</h3>
            </div>
            <div class="card-body reason_field">
                <div class="form-group row">
                    ...
                    @endphp
                    {!! Form::label('Minimum rating for pop-up',__('message.minimum') .' '. __('message.rating') .' '.
                    __('message.for') .' '. __('message.pop_up'), ['class' =>'ul-form__label col-lg-3 col-md-3 col-sm-3
                ...
                <div class="form-group row">
                    <label for="staticEmail"
                        ...
                        {{__('message.reason')}} {{__('message.pop_up')}} {{__('message.title')}}<span
                ...
                <div class="form-group row">
                    <label for="staticEmail"
                        class="ul-form__label col-lg-3 col-md-3 col-sm-3 col-form-label text-right">
                        {{__('message.choose')}} {{__('message.reason')}} {{__('message.apperance')}}.<span
                            class="required">*</span></label>
                ...
                <div class="form-group row">
                    {!! Form::label('reason_font_size',__('message.select').' '.__('message.font_size').' '.
                    __('message.for').' '.__('message.reason').':*', ['class' =>'ul-form__label col-lg-3 col-md-3
                    ...
                    <div class="col-lg-5 col-md-5 col-sm-5 mb-2">
                        ...
                        <div class="input-right-icon">
                            <select name="reason_font_size" class="form-control">
                                <option value="">{{__('message.select')}} {{__('message.font_size')}}</option>
                                @for($i = 1; $i <= 30; $i++) <?php 
                                            $selected = ''; 
                ...
                <div class="form-group row">
                    {!! Form::label('reason_text_color',__('message.select').' '.__('message.text').'
                    '.__('message.color').' '.__('message.for').' '.__('message.reason').':*', ['class'
                ...
                <div class="form-group row">
                    <label for="staticEmail"
                        class="ul-form__label col-lg-3 col-md-3 col-sm-3 col-form-label text-right">
                        {{__('message.add')}} {{__('message.reason')}} {{__('message.for')}} {{__('message.feedback')}}.
        ...
        if(feedback_reason.length > 0){
            $.each(feedback_reason, function(i,elem){
                ...
                if(i == 0){
                    ...
                    $('.reason_field').append('<div class="form-group row"><label class="ul-form__label col-lg-3 col-md-3 col-sm-3 col-form-label text-right">{{__('message.add')}} {{__('message.reason')}} {{__('message.for')}} {{__('message.feedback')}}.</label><div id="reason_'+i+'" class="form-group col-lg-5 col-md-5 col-sm-5 mb-2"><input type="text" name="reason[]" value="'+elem.feedback_reason+'" class="form-control " placeholder="{{__('message.enter')}} {{__('message.reason')}}"></div><div class="col-sm-2 col-md-2 col-lg-2 mb-2"><button type="button" class="btn btn-success btn-sm" id="add">{{__('message.add')}} {{__('message.more')}}</button></div></div>')
                }else{
