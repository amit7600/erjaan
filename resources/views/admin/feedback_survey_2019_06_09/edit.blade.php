...
<div class="row">
    <div class="col-lg-12 mb-3">
        ...
        @endif
        <!--begin::form 2-->
        {!! Form::model($feedback,['route' => ['feedback_survey.update',$feedback->id],'method' => 'PUT',  'class' => 'form-horizontal form-label-left' ]) !!}
            <!-- start REPORT Create KPI Form Layout-->
            <div class="card mb-4">
                <div class="card-header bg-transparent">
                    <h3 class="card-title">{{__('message.edit')}} {{__('message.question')}}</h3>
                </div>
                <div class="card-body">
                    <div class="form-group row">
                        <label  for="name" class="ul-form__label col-lg-3 col-md-3 col-sm-3 col-form-label text-right">{{__('message.question')}}<span class="required">*</span></label>
                        <div class="col-lg-5 col-md-5 col-sm-5 mb-2">
                            {!! Form::text('question',null,['class' => 'form-control']) !!}
                        </div>
                    </div> 
                    <div class="form-group row">
                        <label for="maximum_value" class="ul-form__label col-lg-3 col-md-3 col-sm-3 col-form-label text-right">{{__('message.font_size')}}<span class="required">*</span></label>
                        <div class="col-lg-5 col-md-5 col-sm-5 mb-2">
                    ...
                    <div class="form-group row">
                        <label for="maximum_value" class="ul-form__label col-lg-3 col-md-3 col-sm-3 col-form-label text-right">{{__('message.font')}} {{__('message.color')}}<span class="required">*</span></label>
                        <div class="col-lg-5 col-md-5 col-sm-5 mb-2">
                            {!! Form::text('question_title_color',null,['class' => 'form-control','id' => 'title_color']) !!}
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="maximum_value" class="ul-form__label col-lg-3 col-md-3 col-sm-3 col-form-label text-right">{{__('message.select')}} {{__('message.rating')}} {{__('message.or')}} {{__('message.emoji')}}<span class="required">*</span></label>
                        <div class="col-lg-5 col-md-5 col-sm-5 mb-2">
                            <div class="row">
                                <label class="radio radio-primary ml-4 mt-2">
                                    {!!Form::radio('emoji_rating','emoji',true,array('class' => 'emoji_rating','id' => 'emoji_rating'))!!} 
                                    <span>{{__('message.emoji')}}</span>
                                    <span class="checkmark"></span>
                                </label>
                                <label class="radio radio-primary ml-4 mt-2">
                                    {!!Form::radio('emoji_rating','rating',false,array('class' => 'emoji_rating','id' => 'emoji_rating'))!!}
                        ...
                        <div class="card-body">
                            <div class=" ">
                                <table id="datatable" class="table table-striped table-bordered">
                                    <thead>
                                        <tr>
                                            <th style="width:15%; text-align: center;" class="text-center">{{__('message.rating')}}</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td style="width:25%; text-align: center;">
                                                ...
                                                {!! Form::hidden('emoji_rating_5', $feedback->emoji_rating_5,['id' => 'emoji_rating_5']) !!}
                                                <div id="standalone_5" data-emoji-placeholder=":smiley:"></div>
                                                <div class="emotion">
                                                    <div class="input" contenteditable="false">
                                                        <img src="{{$base_path}}{!! $emoji5 !!}" alt="" title="" style="width: 35px;">
                                                    </div>
                                                    <span class="emotion-Icon">
                                                        <i class="i-Smile" aria-hidden="true"></i>
                                                        <div class="emotion-area"></div>
                                                    </span>
                                                    <input type="hidden" class="emoji" name="emoji_rating_5" value="{{$emoji5}}">
                                                    <!-- <span id="emoji5">{!! $emoji5 !!}</span> -->
                                                </div>
                                            </td>
                                                <td style="text-align: center;">
                                                {!! Form::text('emoji_name_5',null,['class' => 'form-control', 'style' => 'width:50%;']) !!}
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td style="width:25%; text-align: center;">
                                                ...
                                                <div class="emotion">
                                                    <div class="input" contenteditable="false">
                                                        <img src="{{$base_path}}{!! $emoji4 !!}" alt="" title="" style="width: 35px;">
                                                    </div>
                                                    <span class="emotion-Icon">
                                                        <i class="i-Smile" aria-hidden="true"></i>
                                                        <div class="emotion-area"></div>
                                                    </span>
                                                    <input type="hidden" class="emoji" name="emoji_rating_4" value="{{$emoji4}}">
                                                    <!-- <span id="emoji4">{!! $emoji4 !!}</span> -->
                                                </div>
                                            </td>
                                            <td style="text-align: center;">
                                                <!-- <input type="text" name="emoji_name_4" class="form-control"> -->
                                                {!! Form::text('emoji_name_4',null,['class' => 'form-control', 'style' => 'width:50%;']) !!}
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td style="width:25%; text-align: center;">
                                                ...
                                                <div class="emotion">
                                                    <div class="input" contenteditable="false">
                                                        <img src="{{$base_path}}{!! $emoji3 !!}" alt="" title="" style="width: 35px;">
                                                    </div>
                                                    <span class="emotion-Icon">
                                                        <i class="i-Smile" aria-hidden="true"></i>
                                                        <div class="emotion-area"></div>
                                                    </span>
                                                    <input type="hidden" class="emoji" name="emoji_rating_3" value="{{$emoji3}}">
                                                    <!-- <span id="emoji3">{!! $emoji3 !!}</span> -->
                                                </div>
                                            </td>
                                            <td style="text-align: center;">
                                                <!-- <input type="text" name="emoji_name_3" class="form-control"> -->
                                                {!! Form::text('emoji_name_3',null,['class' => 'form-control', 'style' => 'width:50%;']) !!}
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td style="width:25%; text-align: center;">
                                                ...
                                                <div class="emotion">
                                                    <div class="input" contenteditable="false">
                                                        <img src="{{$base_path}}{!! $emoji2 !!}" alt="" title="" style="width: 35px;">
                                                    </div>
                                                    <span class="emotion-Icon">
                                                        <i class="i-Smile" aria-hidden="true"></i>
                                                        <div class="emotion-area"></div>
                                                    </span>
                                                    <input type="hidden" class="emoji" name="emoji_rating_2" value="{{$emoji2}}">
                                                    <!-- <span id="emoji2">{!! $emoji2 !!}</span> -->
                                                </div>
                                            </td>
                                            <td style="text-align: center;">
                                                <!-- <input type="text" name="emoji_name_2" class="form-control"> -->
                                                {!! Form::text('emoji_name_2',null,['class' => 'form-control', 'style' => 'width:50%;']) !!}
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td style="width:25%; text-align: center;">
                                                ...
                                                <div class="emotion">
                                                    <div class="input" contenteditable="false">
                                                        <img src="{{$base_path}}{!! $emoji1 !!}" alt="" title="" style="width: 35px;">
                                                    </div>
                                                    <span class="emotion-Icon">
                                                        <i class="i-Smile" aria-hidden="true"></i>
                                                        <div class="emotion-area"></div>
                                                    </span>
                                                    <input type="hidden" class="emoji" name="emoji_rating_1" value="{{$emoji1}}">
                                                    <!-- <span id="emoji1">{!! $emoji1 !!}</span> -->
                                                </div>
                                            </td>
                                            <td style="text-align: center;">
                                                <!-- <input type="text" name="emoji_name_1" class="form-control"> -->
                                                    {!! Form::text('emoji_name_1',null,['class' => 'form-control', 'style' => 'width:50%;', 'placeholder' => 'Enter Emoji Name']) !!}
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                            ...
                            <div class="mc-footer">
                                <div class="row text-right">
                                    ...
                                    <div class="col-lg-6 text-left">
                                        <input type="submit"  class="btn btn-primary pull-right" value="{{__('message.save')}}">
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">{{__('message.select')}} {{__('message.emoji')}}</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            </div>
            <div class="modal-body emoji_model">
                <input type="hidden" name="emoji" value="" id="emoji_id">
                <button type="button" class="btn btn-sm " value="<i class='fa fa-grin-beam' ></i>" id="emoji" onclick="seleted_emoji(this.value)" ><i class='fa fa-grin-beam' ></i>
                </button>
                <button type="button" class="btn btn-sm " value="<i class='fa fa-angry'></i>" id="emoji" onclick="seleted_emoji(this.value)"><i class='fa fa-angry'></i></button>
                <button type="button" class="btn btn-sm " value="<i class='fa fa-frown' ></i>" id="emoji" onclick="seleted_emoji(this.value)" ><i class='fa fa-frown' ></i></button>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">{{__('message.close')}}</button>
                <button type="submit" id="submit" class="btn btn-primary">{{__('message.send')}} {{__('message.survey')}}</button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
</div><!-- /.modal --> 
...
<style>
    .emoji_model button, .table span {background-color: #fff;font-size: 50px;color: #f6e901;border-radius: 50%;box-shadow:none !important;}
    .emoji_model button i, .table span i{color: #000000;float: right; background: #fff8b8;border-radius: 50%;font-size: 100px;}
    .table span i { font-size: 30px; }
