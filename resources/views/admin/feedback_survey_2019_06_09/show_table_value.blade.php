        ...
        <form class="form-horizontal form-label-left" action="{{ route('feedbackResponce') }}" method="GET">
            ...
            <div class="card mb-4">
                <div class="card-header bg-transparent">
                    <h3 class="card-title">Step 1. Filter Feedback Responce</h3>
                </div>
                <div class="card-body ">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3 col-xs-12 col-md-3">
                            <div class="form-group">
                                <label for="staticEmail" class="ul-form__label col-lg-12 col-md-12 col-sm-12 col-form-label text-left ">Select User <span class="required">*</span></label>
        ...
        <div class="card mb-4 text-left">
            <div class="card-body">
                <h4 class="card-title mb-3">
                    <!-- <a href="{{URL::to('admin/show_table_value/feedbackResponce')}}" class="btn btn-primary float-right mb-4">Export</a> -->
                </h4>
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center" ><i class="i-Happy" style="font-size: 35px;color: #000;background: #40d941;border-radius: 50px;"></i></th>
                                <th class="text-center"><i class="i-Smile" style="font-size: 35px;color: #000;background: #8cd840;border-radius: 50px;"></i></th>
                                <th class="text-center"><i class="i-Friendster" style="font-size: 35px;color: #000;background: #ffd504;border-radius: 50px;"></i></th>
                                <th class="text-center"><i class="i-Depression" style="font-size: 35px;color: #000;background: #d96742;border-radius: 50px;"></i></th>
                                <th class="text-center"><i class="i-Crying" style="font-size: 35px;color: #000;background: #da4241;border-radius: 50px;"></i></th>
