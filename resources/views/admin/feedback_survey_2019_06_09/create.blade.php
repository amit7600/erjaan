...
<div class="row">
    <div class="col-lg-12 mb-3">
        ...
        @endif
        <!--begin::form 2-->
        {!! Form::open(['route' => 'feedback_survey.store', 'files' => true, 'class' => 'form-horizontal form-label-left' ]) !!}
            <!-- start REPORT Create KPI Form Layout-->
            <div class="card mb-4">
                <div class="card-header bg-transparent">
                    <h3 class="card-title">{{__('message.create')}} {{__('message.question')}}</h3>
                </div>
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-5 col-md-5 col-sm-5 mb-2">
                            <input class="form-control" type="text" name="question_title_color" id="title_color" autocomplete="off" placeholder="Enter color code">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="card-body">
                            <div class=" ">
                                <table id="datatable" class="table table-striped table-bordered">
                                    <thead>
                                        <tr>
                                            <th style="width:15%;" class="text-center" scope="col">{{__('message.rating')}}</th>
