...
<div class="row">
    <div class="col-lg-12 mb-3">
        ...
        @endif
        <!--begin::form 2-->
        {!! Form::open(['route' => 'get_user_report_filter_3']) !!}
        <!-- start SURVEY Form Layout-->
        <div class="card mb-4">
            <div class="card-header bg-transparent">
                <h3 class="card-title">{{__('message.filter_for_view_user_chart')}}</h3>
            </div>
            <div class="card-body ">
                <div class="row">
        ...
        <div class="row">
                ...
                foreach ($tempArray as $key => $user) { 
                    ...
                    foreach ($user as $key => $value) {
                        ...
                        $user_id = $value->id;
                            ...
                            $total_result_count = FeedbackHelper::getTotalUser($user_id,'3');
                        ...
                        if($time_period == 'last_14_day'){
                            ...
                            for ($y = $start_number; $y <= $year_month_value; $y++) {
                                ...
                                $user_count = FeedbackHelper::getUserCount($year_data,'3', $user_id,$created_from,$created_to,$time_period);
                            ...
                            $average = array_sum($user_total_count) != 0 ? $total_sum/$total_count : 0 ;

                            
                            $all_average[] = array($value->name,round($average,1),array_sum($user_total_count));
                            $userName[] = $value->name.'('.array_sum($user_total_count).')';
                            $tempBar[] = 0;
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="text-center card card-icon-bg card-icon-bg-primary o-hidden mb-5 pb-2 ">
                    <h3 class="p-2" id="title_columnchart_material_">{{__('message.user_chart')}}
                    </h3>
