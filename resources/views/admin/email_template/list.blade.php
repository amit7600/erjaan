        ...
        <div class="card mb-4 text-left">
            <div class="card-body">
                <h4 class="card-title mb-3">
                    {{__('message.email_campaign')}}
                    <a class="btn btn-success float-right  mb-3"
                        href="{{route('email-template.create')}}">{{__('message.add_email_campaign')}}</a>
                </h4>
...
var ajaxUrl = '{!! route('email-template.index') !!}'; //Url of ajax datatable where you fetch data
