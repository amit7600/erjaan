...
<div class="row">
    <div class="col-lg-12 mb-3">
        ...
        @endif
        <!--begin::form 2-->
        {!! Form::open(['route' => 'complain_chart_filter_5']) !!}
                                ...
                                <div class="x_panel">
                                    <div class="x_content">
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <button class="btn btn-primary mb-3" style="width: 20%;margin: 0 auto;" onclick="printChart('compalinchart_material_<?php echo $complain1->id; ?>','Complain Chart','{{array_sum($response_array)}}')" >Print !</button>
