...
<div class="row">
    <div class="col-lg-12 mb-3">
        ...
        @endif
        <!--begin::form 2-->
        {!! Form::open(['route' => 'reason_chart_filter_3']) !!}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 mb-2 p-0">
                                <div class="input-right-icon">
                                    ...
                                    'city','placeholder' => __('message.select_user')]) !!}
                                    <span class="span-right-input-icon">
                                        <i class="ul-form__icon i-Arrow-Down"></i>
                                    </span>
                                </div>
                                ...
                                <div class="x_panel">
                                    <div class="x_content">
                                        ...
                                        <button class="btn btn-primary mb-3" style="width: 20%;margin: 0 auto;"
                                            onclick="printChart('reasonchart_material_<?php echo $reason_id; ?>','{{__('message.reason_report_chart')}}','{{array_sum($allResponses)}}')">{{__('message.print')}}
                                            !</button>
                                    </div>
                                </div>
