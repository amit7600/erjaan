...
<div class="row">
    <div class="col-lg-12 mb-3">
        ...
        <!--begin::form 2-->
        @if($question == null)
        {!! Form::open(['route' => 'store_question_3', 'files' => 'true', 'method' => 'post', 'class' =>
        'form-horizontal
        form-label-left' ]) !!}
        @else
        {!! Form::model($question,['route' => 'store_question_3', 'files' => 'true','method' => 'put', 'class' =>
        'form-horizontal form-label-left' ]) !!}
        @endif

        <input type="hidden" name="feedback_id" value="3">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    <label for="staticEmail"
                        ...
                        <span class="required">*</span></label>
                    <div class="col-lg-5 col-md-5 col-sm-5 mb-2">
                        {!! Form::number('logo_size', null,['class' => 'form-control','max' => '250']) !!}
                    </div>
                </div>
