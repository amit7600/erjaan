...
<div class="row">
    <div class="col-lg-12 mb-3">
        ...
        @endif
        <!--begin::form 2-->
        {!! Form::open(['route' => 'get_user_report_filter_2']) !!}
                ...
                foreach ($tempArray as $key => $user) { 
                    ...
                    foreach ($user as $key => $value) {
                        ...
                        $user_id = $value->id;
                            ...
                            $total_result_count = FeedbackHelper::getTotalUser($user_id,'2');
                        ...
                        if($time_period == 'last_14_day'){
                            ...
                            for ($y = $start_number; $y <= $year_month_value; $y++) {
                                ...
                                $user_count = FeedbackHelper::getUserCount($year_data,'2', $user_id,$created_from,$created_to,$time_period);
