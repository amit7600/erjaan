...
<div class="breadcrumb">
    <h1>{{__('message.participants_survey_form_report')}}</h1>
</div>
<div class="row">
                        ...
                        <div class="col-lg-5 col-md-5 col-sm-5 mb-2">
                            <div class="input-right-icon">
                                <select class="select2_group form-control" id="survey_form" name="survey_form"
                                    ...
                                    <option
                                        value="<?php echo route('get_survey_report_for_participant',[$form->token]) ?> ">
                                        {{$form->survey_form_title}}
                                        <?php echo '('. date('d-m-Y', strtotime( $form->created_at)). ')' ?></option>
                                    @endforeach
                                </select>
