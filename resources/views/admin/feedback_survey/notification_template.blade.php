                        ...
                        <tbody style="text-align: center;">
                                ...
                                <td style="padding-left:33px;">
                                    ...
                                    <label class="switch switch-primary mr-3">
                                        <input type="checkbox" class="isActive"
                                            onclick="status_change(1,<?php echo $new_status; ?>)"
                                            <?php echo $new_status == 1 ? 'checked' : ''; ?>>
                                        <span class="slider"></span>
                                    </label>

                                </td>
                                <td>
                                    <a class="text-success" href="{{route('view_reason_template',1)}}"><i
                            ...
                            <tr>
                                ...
                                <td style="padding-left:33px;">
                                    <label class="switch switch-primary mr-3">
                                        <input type="checkbox" class="isActive"
                                            onclick="status_change(2,<?php echo $in_progress_status; ?>)"
                                            <?php echo $in_progress_status == 1 ? 'checked' : ''; ?>>
                                        <span class="slider"></span>
                                    </label>
                                </td>
                                <td><a class="text-success" href="{{route('view_reason_template',2)}}"><i
                                            class="i-Eye-Scan text-25 nav-icon font-weight-bold"></i></a></td>
                            </tr>
                            <tr>
                                <td>3</td>
                                ...
                                <td style="padding-left:33px;">
                                    <label class="switch switch-primary mr-3">
                                        <input type="checkbox" class="isActive"
                                            onclick="status_change(3,<?php echo $resolve_status; ?>)"
                                            <?php echo $resolve_status == 1 ? 'checked' : ''; ?>>
                                        <span class="slider"></span>
                                    </label>
                                </td>
                                <td>
                                    <a class="text-success" href="{{route('view_reason_template',3)}}"><i
                                            class="i-Eye-Scan text-25 nav-icon font-weight-bold"></i></a>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td style="padding-left:33px;">
                                    <label class="switch switch-primary mr-3">
                                        <input type="checkbox" class="isActive"
                                            onclick="status_change(4,<?php echo $late_status; ?>)"
                                            <?php echo $late_status == 1 ? 'checked' : ''; ?>>
                                        <span class="slider"></span>
                                    </label>
                                </td>
                                <td>
