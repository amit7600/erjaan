    ...
    <div class="col-lg-12 mb-3">
        ...
        <div class="card mb-4">
            <div class="card-header bg-transparent">
                <h3 class="card-title">{{__('message.filter_for_view_complain_chart')}}</h3>
            </div>
            <div class="card-body ">
                <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card card-icon-bg card-icon-bg-primary o-hidden mb-4">
                    ...
                    {{-- <h3 class="text-center m-0 mb-3 p-2">{{__('message.complain_status')}}
                    {{__('message.chart')}}</h3> --}}
                    <div class="text-center">
                        ...
                        <div id="printableArea">
                            ...
                            <div class="">
                                <div class="x_panel">
                                    <div class="x_content">
                                        <h3 class="text-center m-0 p-2">{{__('message.complain_status_chart')}}</h3>
                                        <div class="col-sm-12">
                                            <div id="compalinchart_material_<?php echo $complain1->id; ?>"
                                                style="width: 100%; min-height: 400px; margin: 0 auto"></div>
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <p class="text-16 mt-1 mb-1 text-center"><b>
                                                            {{__('message.no_of_responses')}} :</b>
                                            ...
                                            <div class="row">
                                                <div class="col-md-3 col-3 text-center">
                                                    <p class="text-14 mt-1 mb-3"><b>{{__('message.new')}}:</b>
                                                        {{array_sum($new_response)}}</p>
                                                </div>
                                                <div class="col-md-3 col-3 text-center">
                                                    <p class="text-14 mt-1 mb-3"><b>{{__('message.inProgress')}}:</b>
                                                        {{array_sum($inProgress_response)}}</p>
                                                </div>
                                                <div class="col-md-3 col-3 text-center">
                                                    <p class="text-14 mt-1 mb-3"><b>{{__('message.resolved')}}:</b>
                                                        {{array_sum($resolved_response)}}</p>
                                                </div>
                                                <div class="col-md-3 col-3 text-center">
                                                    <p class="text-14 mt-1 mb-3"><b>{{__('message.late')}}:</b>
                                                        {{array_sum($late_response)}}</p>
                                                </div>
                                            </div>
                                            <button class="btn btn-primary mb-3" style="width: 20%;margin: 0 auto;"
                                                onclick="printChart('compalinchart_material_<?php echo $complain1->id; ?>','Complain Chart','{{array_sum($response_array)}}')">{{__('message.print')}}
                                                !</button>
...
<script>
    $(document).ready(function(){
            ...
            var time_period = $('#time_period').val() != '' ? $('#city').val() : '{{__('message.all')}}';
