    ...
    <div class="col-lg-12 mb-3">
        ...
        <div class="card mb-4">
            <div class="card-header bg-transparent">
                <h3 class="card-title">{{__('message.notification_template')}}</h3>
            </div>
            <div class="card-body">
                <div class="form-group row">
                    <label for="name"
                        class="ul-form__label col-lg-3 col-md-3 col-sm-3 col-form-label text-right">{{__('message.select_template')}}<span
                            class="required">*</span></label>
                    <div class="col-lg-5 col-md-5 col-sm-5 mb-2">
                        {!! Form::select('status_template',['email' => __('message.e-mail'),'sms' =>
                        __('message.sms'),'both' => __('message.both')], $status_template, ['class' =>
                        'form-control','id' => 'template','placeholder' => __('message.select').'
                        '.__('message.template').' '.__('message.type')]) !!}
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="card-body">
                            ...
                            <table id="datatable" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <th>{{__('message.customer_variable')}}</th>
                        ...
                        <div class="row">
                            <div class="form-group col-sm-6 row sms_template">
                                <label for="name"
                                    class="ul-form__label col-lg-3 col-md-3 col-sm-3 col-form-label text-right">{{__('message.sms_template_for_user')}}<span
                                        class="required">*</span></label>
                                <div class="col-lg-9 col-md-5 col-sm-5 mb-2">
                                    {!! Form::textarea('sms_template', $sms_template, ['class' => 'form-control','id' =>
                                    'sms_template','placeholder' => __('message.enter').' ' .__('message.sms').'
                                    '.__('message.for') .' '.__('message.user')]) !!}
                                </div>
                            </div>
                            <div class="form-group col-sm-6 row customer_sms_template">
                                <label for="name"
                                    class="ul-form__label col-lg-3 col-md-3 col-sm-3 col-form-label text-right">{{__('message.sms_template_for_customer')}}<span
                                        class="required">*</span></label>
                                <div class="col-lg-9 col-md-5 col-sm-5 mb-2">
                                    {!! Form::textarea('customer_sms_template', $customer_sms_template, ['class' =>
                                    'form-control','id' => 'customer_sms_template','placeholder' => 'Enter message for
                                    customer']) !!}
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-sm-6 row email_template">
                                <label for="name"
                                    class="ul-form__label col-lg-3 col-md-3 col-sm-3 col-form-label text-right">{{__('message.email_template_for_user')}}<span
                                        class="required">*</span></label>
                                <div class="col-lg-9 col-md-5 col-sm-5 mb-2">
                                    {!! Form::textarea('email_template', $email_template, ['class' =>
                                    'form-control','id' => 'email_template','placeholder' => 'Enter email message for
                                    user']) !!}
                                </div>
                            </div>
                            <div class="form-group col-sm-6 row customer_email_template">
                                <label for="name"
                                    class="ul-form__label col-lg-3 col-md-3 col-sm-3 col-form-label text-right">{{__('message.email_template_for_customer')}}<span
                                        class="required">*</span></label>
                                <div class="col-lg-9 col-md-5 col-sm-5 mb-2">
                                    {!! Form::textarea('customer_email_template', $customer_email_template, ['class' =>
                                    'form-control','id' => 'customer_email_template','placeholder' => 'Enter email
                        ...
                        <div class="form-group row">
                            <label for="name"
                                class="ul-form__label col-lg-3 col-md-3 col-sm-3 col-form-label text-right">{{__('message.select_user')}}<span
                                    class="required">*</span></label>
                            <div class="col-lg-5 col-md-5 col-sm-5 mb-2">
                        ...
                        <div class="form-group row">
                            <label for="name"
                                class="ul-form__label col-lg-3 col-md-3 col-sm-3 col-form-label text-right">{{__('message.send_copy_to_customer')}}<span
                                    class="required">*</span></label>
                            <div class="col-lg-5 col-md-5 col-sm-5 mb-2">
                                <div class="row">
