...
<div class="breadcrumb">
    <h1>{{__('message.reason_guage_report')}}</h1>
</div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 mb-2 p-0">
                                <div class="input-right-icon">
                                    ...
                                    'user','placeholder' => __('message.select_location')]) !!}
        ...
        function drawChart() {
            ...
            $.ajax({
                ...
                if (resp) 
                {
                    ...
                    var kpiSum = '{{__('message.kpi_total')}} : ';
                ...
                if (resp) 
                {
                    ...
                    }else
                    {
                        ...
                        var max = resp['reason_count'].maximum_value;
                            ...
                            $('#choose_question').append(' <table class="table" style="width: 50%; float: left;"> <tr> <td style="border-top:none;"> <div class="text-center card card-icon-bg card-icon-bg-primary o-hidden pb-2"> <div style="height: 400px;"> <h3 class="p-2 text-16">{{__('message.reason')}}: '+ resp['reason_count'][i].feedback_reason +' </h3> <div class="col-md-12 col-sm-12 col-xs-12" id="reason_div_' + i + '" style="height: 400px;"></div></div><div class="row"> <div class="col-md-12 col-12 text-center"> <p class="text-14 mt-1 mb-1"><b>{{__('message.no_of_responses')}}:</b> '+ resp.reason_value[i][0] +'</p></div></div><div class="row"> <div class="col-md-12" style="text-align: center !important;"> <button class="btn btn-primary mb-3" style="width: 20%;margin: 0 auto;" data-name="'+ resp['reason_count'][i].feedback_reason +'" data-id="reason_div_'+ i +'" data-value="'+ resp.reason_value[i][0] +'" onclick="printChart(this)">{{__('message.print')}} !</button> </div></div> <div class="append_filter"></div></div></td></tr></table>');
