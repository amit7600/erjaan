...
<div class="breadcrumb">
    <h1>{{__('message.complain_guage_report')}}</h1>
</div>
    ...
    <div class="col-lg-12 mb-3">
        ...
        <div class="card mb-4">
            <div class="card-header bg-transparent">
                <h3 class="card-title">{{__('message.filter_complain_report')}}</h3>
            </div>
            <div class="card-body ">
                <div class="row">
