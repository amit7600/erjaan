        ...
        <div class="card mb-4 text-left">
            <div class="card-body">
                <h4 class="card-title mb-3">
                    {{__('message.sms_campaign_list')}}
                    <a class="btn btn-success float-right  mb-3"
                        href="{{route('sms-template.create')}}">{{__('message.add_sms_campaign')}}</a>
                </h4>
...
var ajaxUrl = '{!! route('sms-template.index') !!}'; //Url of ajax datatable where you fetch data
