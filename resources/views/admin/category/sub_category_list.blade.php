        ...
        <div class="card mb-4 text-left">
            <div class="card-body">
                <h4 class="card-title mb-3">
                    {{__('message.sub_categor_list')}}
                    <a style="float:right" class="btn btn-success float-right mb-4"
                        href="{{route('sub_category.create')}}">{{__('message.add_sub_category')}}</a>
                </h4>
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center">{{__('message.sub_category')}} {{__('message.name')}}</th>
...
var ajaxUrl = '{!! route('sub_category_list',Request::segment(3)) !!}'; //Url of ajax datatable where you fetch data
