...
$title = __('message.create').' '.__('message.sub_category');
...
if (!empty($repairman_data->id)) {
    $edit = true;
    $title = __('message.edit').' '.__('message.sub_category');
    $action = route('sub_category.update', $repairman_data->id);
                ...
                <div class="card-body">
                            ...
                            <div class="input-right-icon">
                                <select class="select2_group form-control" id="category_id" name="category_id">
                                    ...
                                    if (!empty($repairman_data)) {
                                        if ($repairman_data->parent_id == $row->id)
                                            $selected = 'selected';
                                    }
                                    ?>
                    ...
                    <div class="form-group row">
                        <label for="staticEmail"
                            ...
                            {{__('message.name')}} <span class="required">*</span></label>
                        <div class="col-lg-5 col-md-5 col-sm-5 mb-2">
