        ...
        <!-- start SURVEY Form Layout-->
            <div class="card mb-4">
                <div class="card-header bg-transparent">
                    <h3 class="card-title">{{__('message.create')}} {{__('message.role')}}</h3>
                </div>
                <div class="card-body">
                        ...
                        <div class="col-sm-6 col-md-6 col-xs-12 mb-4">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <label for="staticEmail" class="ul-form__label col-lg-9  col-md-9 col-sm-9 col-form-label text-left pl-4"><b>{{__('message.complain')}} {{__('message.menu')}}</b></label>
                                        <div class="col-lg-2  col-md-2 col-sm-2 mb-2">
                                            <label class="checkbox checkbox-primary">
