<!-- start Feedback KPI Report here -->
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12">
        <div class="card card-icon-bg card-icon-bg-primary o-hidden mb-4">
            <h3 class="text-center m-0 mb-3 p-2">{{__('message.feedback_kpi_report')}}</h3>
            ...
            <div class="text-center">
                ...
                <div id="printableArea">
                    <div id="showList"></div>
                    <div id="feedback_kpi_count" class="col-md-12 col-sm-12 col-xs-12"></div>
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div id="feedback_kpi" class="table-responsive">
                        </div>
                    </div>
                </div>
            </div>
...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12">
        <div class="card card-icon-bg card-icon-bg-primary o-hidden mb-4">
            <h3 class="text-center m-0 mb-3 p-2"> {{__('message.feedback_terminal_chart')}} </h3>
            {{-- <div class="separator-breadcrumb border-top"></div> --}}
            <div class="text-center">
                <input type="hidden" id="survey_form" name="survey_form"
                    value="<?php echo!empty($survey_form_id) ? $survey_form_id : '1' ?>">
                ...
                <div class="row" style="width: 100%;">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div class="text-center card card-icon-bg card-icon-bg-primary o-hidden mb-5 pb-2 ">
                            ...
                            <div id="columnchart_material_<?php echo $question_id; ?>" class="p-3"
