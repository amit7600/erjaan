...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12">
        <div class="card card-icon-bg card-icon-bg-primary o-hidden mb-4">
            <h3 class="text-center m-0 mb-3 p-2">{{__('message.feedback')}} {{__('message.reason_3')}}</h3>
            <div class="text-center">
                ...
                <div id="printableArea">
                    ...
                    <?php
                        ...
                        if (count($feedback_reason_data3) > 0) {
                            $chart_bar = array();
                            foreach ($feedback_reason_data3 as $key1 => $reason1) 
                            {
                                ...
                                $reasonData = json_decode($monthValueData3);
                                $yearValue =  $monthValues3;
                            }
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_content">
                                <div id="reasonchart_3_material_<?php echo $reason_id; ?>"
                        ...
                        <script type="text/javascript">
                            let reasonchart_3_material_<?php echo $reason_id; ?> = document.getElementById('reasonchart_3_material_<?php echo $reason_id; ?>');
                                    if (reasonchart_3_material_<?php echo $reason_id; ?>) {
                                        let reason_pie = echarts.init(reasonchart_3_material_<?php echo $reason_id; ?>);
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <script type="text/javascript">
                            ...
                            var echartElemBar = document.getElementById('reasonchart_3_material_<?php echo $reason_id; ?>');
                            if (echartElemBar) {
                        ...
                        <div id="reasonchart_3_material_<?php echo $reason_id; ?>" class="p-3" style="height: 400px;">
                        </div>

                        <div class="row">
                            @foreach ($feedback_reason_data3 as $key=>$value)
                            @php
                            $feedback_reason = $value->feedback_reason
                            @endphp
                            <div class="col-md-4">
                                <p class="text-16 mt-1 mb-3 text-center"><b>{{$feedback_reason}}:</b>
                                    {{$response_array3 [$key][$feedback_reason]}}</p>
                            </div>
                            @endforeach
                        </div>
                    </div>
