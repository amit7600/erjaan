...
function closeFullscreen() {
  ...
  .overlay_img {    position: fixed;
    height: 100vh;
    top: 0;
    z-index: 1;
    width: 100%;}
    .overlay_img + .inner_body {    position: relative;
    top: 0;
    z-index: 1050;}
    ...
    .gl-star-rating-stars span:first-child:before {
      content: '{{ $selected_feedback_question->low_rating_name }}';
    }

    /* .gl-star-rating-stars span:nth-child(2):before {
      content: '2';
    }

    .gl-star-rating-stars span:nth-child(3):before {
      content: '3';
    }

    .gl-star-rating-stars span:nth-child(4):before {
      content: '4';
    } */

    .gl-star-rating-stars span:nth-child(5):before {
      content: '{{ $selected_feedback_question->high_rating_name }}';
    }
    ...
    .only_question_1 .innner_question_ans .images.large ul li img {
      max-width: 100%
    }

    .only_question_1 .innner_question_ans .images.medium ul li img {
      max-width: 80%
    }

    .only_question_1 .innner_question_ans .images.small ul li img {
      max-width: 60%
    }
