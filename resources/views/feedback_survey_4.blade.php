...
<body id="myFullscreen" class="only_question_1" onload="sequence()">
  ...
  {{--<div class="overlay_img" style="background-image: url('{{$base_path}}{{$selected_feedback_question ?     $selected_feedback_question->question_form_background_mobile : ''}}'); background-color: {{$selected_feedback_question ? $selected_feedback_question->question_background_color : ''}} ; background-size:cover;   background-repeat: no-repeat; background-attachment: fixed;  background-position: center; " ></div>--}}
   <?php     //}else{ ?>
    ...
    <div class="inner_bg">
      ...
      <div class="main_heading ">
        <div class="innner_question_ans ">
          ...
          {!! Form::hidden('feedback_id',4,['id' => 'feedback_id']) !!}          
          ...
          @for($i=0; $i< count($question); $i++) <div id="div_{{$i}}" class="panel">
            ...
            <div class="form-field margin_top {{$emoji_and_rating_size}}">
              ...
              <select id="glsr-ltr" class="star-rating rating-list star_option">
                ...
                <option value="5" id="<?php echo $question[$i]->id .'_'. $i; ?>">{{__('message.fantastic')}}</option>
              </select>
            </div>
            @endif
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header" style="background-color: {{$complain_header_color}};">
          <h4 class="modal-title">{{$selected_feedback_question ? $selected_feedback_question->reason_title : 'Reason'}}
          </h4>
          ...
          <div class="col-sm-12">
            ...
            <div class="radio">
              <label id="label_commentRadio_{{$value->id}}"
                ...
                {!! Form::radio('comment',$value->feedback_reason,false,['id' => 'commentRadio_'.$value->id , 'onclick'
          ...
          <div class="row">
            <div class="form-group">
              ...
              <div class="col-sm-6">
                ...
                {!! Form::email('email',null,['class' => 'form-control','id' => 'email', 'placeholder' => $email_label])
                !!}
              </div>
            </div>
          </div>
  ...
  <script type="text/javascript">
    ...
    function comment_radio(e){
            ...
            $('#comment_id').val(e.id);
            var url = "{{ route('feedBackRatings_4') }}"
...
function closeFullscreen() {
  ...
  <style type="text/css" media="screen">
    ...
    .model_question.complain_form .radio label {background: #e5efe7;padding: 20px;cursor: pointer;border-radius: 6px;border: 1px solid #4d928a;box-shadow: 4px 4px 3px rgba(0, 0, 0, 0.23);font-size: 18px;width: 100%;margin-bottom: 20px;color: #000;text-align: right;}.model_question.complain_form .radio label:hover, .model_question.complain_form .radio label:focus, .model_question.complain_form .radio label.active {background: #c2efea }
    .gl-star-rating.gl-star-rating-rtl {display: inline-block;}
    .gl-star-rating-stars {height: inherit;margin-bottom: 40px;}
    .gl-star-rating-stars span, .gl-star-rating-stars.s10 span, .gl-star-rating-stars.s20 span, .gl-star-rating-stars.s30 span, .gl-star-rating-stars.s40 span, .gl-star-rating-stars.s50 span {position: relative;}
    .gl-star-rating-stars.s0 + .gl-star-rating-text {display: none }
    .gl-star-rating-rtl[data-star-rating] 
    .gl-star-rating-text:before {left: unset;top: -25px;right: 10px;border-width: 11px 10px 14px 10px;border-color: transparent transparent #ffb900 transparent;}
    .gl-star-rating-stars.s10 + .gl-star-rating-text {position: absolute;left: 76%;top: 100%;background: #ffb900;color: #000;font-size: 20px;padding: 5px 16px;height: auto;}
    .gl-star-rating-stars.s20 + .gl-star-rating-text {position: absolute;left: 60%;top: 82%;background: #ffb900;color: #000;font-size: 20px;padding: 5px 16px;height: auto;}
    .gl-star-rating-stars.s30 + .gl-star-rating-text {position: absolute;left: 37%;top: 82%;background: #ffb900;color: #000;font-size: 20px;padding: 5px 16px;height: auto;}
